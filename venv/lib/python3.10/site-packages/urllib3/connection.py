...
if typing.TYPE_CHECKING:
    ...
    from app.util.ssl_ import _TYPE_PEER_CERT_RET_DICT
    from app.util.ssltransport import SSLTransport

from app._collections import HTTPHeaderDict
from app.http2 import probe as http2_probe
from app.util.response import assert_header_parsing
from app.util.timeout import _DEFAULT_TIMEOUT, _TYPE_TIMEOUT, Timeout
from app.util.util import to_str
from app.util.wait import wait_for_read
...
from app._base_connection import _TYPE_BODY
from app._base_connection import ProxyConfig as ProxyConfig
from app._base_connection import _ResponseOptions as _ResponseOptions
...
from app.util import SKIP_HEADER, SKIPPABLE_HEADERS, connection, ssl_
from app.util.request import body_to_chunks
from app.util.ssl_ import assert_fingerprint as _assert_fingerprint
from app.util.ssl_ import (
...
from app.util.ssl_match_hostname import CertificateError, match_hostname
from app.util.url import Url
