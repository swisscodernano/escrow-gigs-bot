...
if typing.TYPE_CHECKING:
    from app._base_connection import BaseHTTPConnection
...
from app.connection import BaseSSLError, HTTPConnection, HTTPException
...
from app.util.response import is_fp_closed, is_response_to_head
from app.util.retry import Retry

if typing.TYPE_CHECKING:
    from app.connectionpool import HTTPConnectionPool
