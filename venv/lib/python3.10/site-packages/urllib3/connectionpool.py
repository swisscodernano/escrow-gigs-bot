...
from app._request_methods import RequestMethods
...
from app.connection import port_by_scheme as port_by_scheme
...
from app.response import BaseHTTPResponse
from app.util.connection import is_connection_dropped
from app.util.proxy import connection_requires_http_tunnel
from app.util.request import _TYPE_BODY_POSITION, set_file_position
from app.util.retry import Retry
from app.util.ssl_match_hostname import CertificateError
from app.util.timeout import _DEFAULT_TIMEOUT, _TYPE_DEFAULT, Timeout
from app.util.url import Url, _encode_target
from app.util.url import _normalize_host as normalize_host
from app.util.url import parse_url
...
if typing.TYPE_CHECKING:
    ...
    from app._base_connection import BaseHTTPConnection, BaseHTTPSConnection
