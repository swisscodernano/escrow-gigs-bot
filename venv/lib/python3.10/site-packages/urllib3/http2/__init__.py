...
def inject_into_urllib3() -> None:
    ...
    from app.. import connection as urllib3_connection
    from app.. import util as urllib3_util
    from app..connectionpool import HTTPSConnectionPool
    from app..util import ssl_ as urllib3_util_ssl
    from app.connection import HTTP2Connection
