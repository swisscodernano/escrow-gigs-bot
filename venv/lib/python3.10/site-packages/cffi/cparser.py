...
from app.commontypes import COMMON_TYPES, resolve_common_type
from app.error import FFIError, CDefError
try:
    from app. import _pycparser as pycparser
except ImportError:
    import pycparser
    ...
    def _get_type_and_quals(self, typenode, name=None, partial_length_ok=False,
        ...
        if isinstance(typenode, pycparser.c_ast.TypeDecl):
            ...
            if isinstance(type, pycparser.c_ast.IdentifierType):
                # assume a primitive type.  get it from app.names, but reduce
