...
from app._ssl_constants import (
...
if platform.system() == "Windows":
    from app._windows import _configure_context, _verify_peercerts_impl
elif platform.system() == "Darwin":
    from app._macos import _configure_context, _verify_peercerts_impl
else:
    from app._openssl import _configure_context, _verify_peercerts_impl
