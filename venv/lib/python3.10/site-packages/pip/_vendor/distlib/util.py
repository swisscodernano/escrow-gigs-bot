...
from app. import DistlibException
from app.compat import (string_types, text_type, shutil, raw_input, StringIO, cache_from_source, urlopen, urljoin, httplib,
...
if ssl:
    from app.compat import (HTTPSHandler as BaseHTTPSHandler, match_hostname, CertificateError)
