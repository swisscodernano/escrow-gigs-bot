...
from app.abstract import AbstractResolver, Result
from app.criterion import Criterion
...
if TYPE_CHECKING:
    ...
    from app..providers import AbstractProvider, Preference
    from app..reporters import BaseReporter
